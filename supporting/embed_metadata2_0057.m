...
switch user
    ...
    case 'dave'
        ...
        default.source_path = '/Users/Kelbe/Desktop/Delivery/';
        %default.parentpath = '/Volumes/EnGedi/Summer/Capture/FLATTENED/';
        default.parentpath = '/Volumes/My Book/DJK/2014.05/Capture/FLATTENED/';
       % default.parentpath = '/Volumes/Babel/2013-05/';
        ...
        default.outdir =  '/Users/Kelbe/Desktop/DJK-2014-12-21-Delivery-01/';
        default.excelpath = '/Users/Kelbe/Documents/EMEL/Sinai/Processed/Log/';
        default.exifpath = '/Volumes/My Book/DJK/2014.05/Capture/FLATTENED/';
end
...
filepath_cubelist = sprintf('%s%s', path_cubelist, filename_cubelist);
...
% Choose source file
%cd(default.source_path);
%[SourceFiles, source_path] = uigetfile('*.tif','Please choose a file for submission', 'MultiSelect', 'on');
% 
...
%     shot= str2double(SourceFile(6:11));
%  if shot~=243;
%      continue
%  end
%     if mod(shot,2)==0
...
%     
    ...
    wavelength_all = char(unique(wavelength_all));
