...
for m = 1:n_m
    ...
    filepath_chopsticks_mask_jpg =  sprintf('%s%s_chopsticks_mask.jpg',subpath_jpg_dir{m},m_name{m});
    ...
    mask_sam = logical(sam < 2);
    mask_sam = imclose(mask_sam, strel('disk', 100));
